(* ============================================================ *)
(* raw_outcome_model.m                                          *)
(* Alternative derivation using raw outcomes (not change scores)*)
(* Diagonal R = a*I, covariance V = a*I + b*t*t'               *)
(* Constraints: t1^2 + t2^2 = 1, t1 + t2 = 0 (centered time)  *)
(* Corresponds to handwritten notes dated 10/7                  *)
(* ============================================================ *)
