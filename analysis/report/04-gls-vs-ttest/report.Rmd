...
longer optimal. The averaged change-score estimator's
definition does not depend on the assumed value, so its
variance is constant across the sweep. Note the scale of
